...
#define CCACHE_BIN_ELEMENTS ((((CCACHE_BIN_DESIRED_ELEMENTS * sizeof(void*) + CACHELINE) & ~(CACHELINE - 1)) - sizeof(void**)) / sizeof(void*))
...
struct ccache_s {
	...
	ccache_bin_t bins[];    // EXPLAINER: https://wikiless.org/wiki/Flexible_array_member?lang=en
};
