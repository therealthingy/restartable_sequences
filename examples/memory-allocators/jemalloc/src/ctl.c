...
CTL_PROTO(opt_ccache_force_cpu_id)  /* $$$  cid addition  $$$ */
...
static const ctl_named_node_t opt_node[] = {
	...
	{NAME("ccache_force_cpu_id"),	CTL(opt_ccache_force_cpu_id)},  /* $$$  cid addition  $$$ */
...
CTL_RO_NL_GEN(opt_ccache_force_cpu_id, opt_ccache_force_cpu_id, bool)  /* $$$  cid addition  $$$ */
